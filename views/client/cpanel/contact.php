					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 03789456789</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> bqt@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
                                <li><a href="https://www.facebook.com/BuiQuangThai01/"><i class="fa fa-facebook"></i></a></li>
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>E-SHOPPER</p>
							<p>Tp.Cần Thơ</p>
							<p>Số Điện thoại: 03789456789</p>
							<p>Email: bqt@gmail.com</p>
	    				</address>
	    			</div>
    			</div>    			
	    	</div>  
