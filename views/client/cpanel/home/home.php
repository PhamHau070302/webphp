					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-5">
                                <h1>Mua Sắm Nhiều Ưu Đãi</h1>
									<h2>Sự Kiện</h2>
									<!-- <button type="button" class="btn btn-default get">Get it now</button> -->
								</div>
								<div class="col-sm-7">
									<img style="min-height: 400px; object-fit: cover;max-height: 300px;min-width: 550px;" src="public/images/img_banners/banner3.png" class="girl img-responsive" alt="" />
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img style="min-height: 400px; object-fit: cover;max-height: 400px;min-width: 390px;" src="public/images/img_banners/<?=$values['slider_img']?>" class="girl img-responsive" alt="" />
								</div>
							</div>
							<?php }?>
						</div>
                    ...
                    <div class="tab-content">
                        <?php foreach($data["productnew"] as $key=>$values){?>
                            <div class="tab-pane fade active in" id="tshirt" >
                                <div class="col-sm-3">
                                    <div class="product-image-wrapper" style="max-height: 400px; min-height: 500px;">
